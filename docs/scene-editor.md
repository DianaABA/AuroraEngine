...
See also: templates/minimal/README.md (Scene Editor walkthrough) for hands-on steps.


Visual map: The editor includes a mini SVG graph of scene nodes/edges with hover tooltips; broken links are flagged above the list and in red on the graph.
