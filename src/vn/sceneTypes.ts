...
export type SpriteSwapStep = { type:'spriteSwap'; id: string; src: string }
...
export type TransitionStep = { type:'transition'; kind:'fade'|'slide'|'zoom'|'shake'|'flash'; duration?: number }
